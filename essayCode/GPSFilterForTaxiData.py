...
def getAttrFromCSVtoGraph(filePath):
    ...
    for chunk in pd.read_csv(filePath, chunksize=chunksize):
        ...
        with open("E:/data/ExprimentField/trip_data1_Manhatan.csv", "w", newline="") as csvfile:
        ...
        # print(edgesArray)
        # print(len(edgesArray[0]))
        # print(edgesArray[0][10])
        # print(edgesArray[0][11])
        # print(edgesArray[0][12])
        # print(edgesArray[0][13])
        # 对其按照第1列排序
